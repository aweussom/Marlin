...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   */
  //#define SD_SPI_SPEED SPI_HALF_SPEED //wossname - made no difference
  #define SD_SPI_SPEED SPI_QUARTER_SPEED
  // The standard SD detect circuit reads LOW when media is inserted and HIGH when empty.
  // Enable this option and set to HIGH if your SD cards are incorrectly detected.
  //#define SD_DETECT_STATE HIGH //wossname - utgjorde ingen forskjell
   ...
   */
  #define SDCARD_CONNECTION LCD //wossname

  // Enable if SD detect is rendered useless (e.g., by using an SD extender)
  //#define NO_SD_DETECT //wossname
 ...
 */
#define NO_SD_HOST_DRIVE   // Disable SD Card access over USB (for security) //wossname
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.22 }    // (mm) Compression length per 1mm/s extruder speed, per extruder //wossname - define after calibration
  #else
