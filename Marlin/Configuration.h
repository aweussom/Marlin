...
#define STRING_CONFIG_H_AUTHOR "(w, Sidewinder X1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SWX1 20250114 W" //wossname

#define NO_AUTO_ASSIGN_WARNING //wossname - PIO assigns the free E stepper to dual Z
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  15.96 //wossname - calibrated
...
#define PIDTEMPBED
  ...
  // Sidewinder X1
  #define DEFAULT_bedKp 244.21 //wossname - needs calibration
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 445 } //wossname - calibrate, and add values here
...
#define MESH_BED_LEVELING //wossname - requires 12864 type display
...
#define ENABLE_LEVELING_AFTER_G28 //wossname
...
#define PREHEAT_BEFORE_LEVELING
  ...
  #define LEVELING_NOZZLE_TEMP 155   // (°C) Only applies to E0 at this time
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 4 //wossname
  ...
  #define GRID_MAX_POINTS_X 4    // Don't use more than 7 points per axis, implementation limited. //wossname
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
 ...
 */
#define LCD_BED_LEVELING //wossname - for 12864 type display
...
#define LCD_BED_TRAMMING //wossname
...
#define DISABLE_M503        // Saves ~2700 bytes of flash. Disable for release! //wossname
...
#define PREHEAT_1_TEMP_HOTEND 180 //wossname
#define PREHEAT_1_TEMP_BED     60 //wossname
 ...
 */
#define NOZZLE_PARK_FEATURE //wossname
 ...
 */
#define SD_CHECK_AND_RETRY //wossname
...
//
#define REVERSE_ENCODER_DIRECTION //wossname
...
//
#define MKS_MINI_12864_V3 //wossname
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_TYPE          NEO_RGB //wossname
